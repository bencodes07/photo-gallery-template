# Next.js Photography Gallery

## Getting Started

Add your images to the `public/images` directory. The images should be in a regular image format.

Then, create the image list and start the development server:
